    ...
    <div className="min-h-screen bg-brand-bg flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-500 text-sm">Expense Intelligence Platform</p>
        </div>

        <div className="bg-white rounded-xl shadow-card border border-gray-100 p-8">
          <h1 className="text-xl font-semibold text-brand-primary mb-6">Sign in to your account</h1>
